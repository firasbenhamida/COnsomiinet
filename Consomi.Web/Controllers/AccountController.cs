        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    if (model.Email == "livreur@hotmail.com" || model.Email == "livreur1@hotmail.com" || model.Email == "livreur2@hotmail.com" || model.Email == "livreur3@hotmail.com" || model.Email == "livreur4@hotmail.com" || model.Email == "livreur5@hotmail.com" || model.Email == "livreur6@hotmail.com")
                    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (model.Email == "livreur@hotmail.com" || model.Email == "livreur1@hotmail.com" || model.Email == "livreur2@hotmail.com" || model.Email == "livreur3@hotmail.com" || model.Email == "livreur4@hotmail.com" || model.Email == "livreur5@hotmail.com" || model.Email == "livreur6@hotmail.com")
                    {
                        ...
                        livreur.Mail = model.Email;
                        livreur.activite = 0;
                        livreur.adresse = model.PhoneNumber;
                        livreur.id = user.Id;
